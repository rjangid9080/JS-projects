...
function displayMenu(menuItems) {
  ...
  return sectionCenter.innerHTML=displayMenu;
}
...
function menuBtns() {
  ...
  const Btns = categories.map(function (itemCategory) {
  ...
  filterBtns.forEach(function (btn) {
    btn.addEventListener("click", function (item) {
      ...
      const filteredMenu = menu.filter(function (filterItems) {
...
// Read more on document.createElement 
//and try to rewrite displayMenu() using the same
